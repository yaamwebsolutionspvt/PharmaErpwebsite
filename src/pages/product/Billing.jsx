...
const Billing = () => {
  ...
  return (
    <>
      <Seo
        title="Medical Store Billing Software — Chemist Shop Billing System"
        description="Professional pharmacy billing software with GST compliance, multiple payment modes, and instant invoice generation. Perfect billing solution for medical stores and chemist shops."
        keywords={[
        ...
        url="https://mediyaam.example.com/product/billing"
        canonical="https://mediyaam.example.com/product/billing"
        type="website"
        schema={schema}
      />
          ...
          <SectionReveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Professional billing solution for pharmacies with GST compliance,
                multiple payment options, and instant invoice generation.
              </p>
            </div>
          </SectionReveal>
        </div>

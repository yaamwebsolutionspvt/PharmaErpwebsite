...
const Home = () => {
  ...
  return (
    <>
      <Seo
        title="Best Pharmacy Software in India | Top Pharmacy Management System - Mediyaam"
        description="Mediyaam is the best pharmacy management software in India. Complete pharmacy billing software with POS, inventory, and GST compliance. Trusted by 10,000+ medical stores across India. Free trial available."
        keywords={[
          'best pharmacy software in india',
          ...
          'retail pharmacy software india',
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  Best Pharmacy Software in India for{' '}
                ...
                >
                  India's top-rated pharmacy billing software trusted by 10,000+ medical stores. Complete pharmacy management system with billing, inventory, POS, and multi-branch management. Serving pharmacies across Chennai, Hyderabad, Kerala, and all of India.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                    ...
                    {benefits.map((benefit, index) => (
                      ...
                      >
                        <motion.div
                          ...
                          transition={{ delay: index * 0.1 + 0.2, type: 'spring' }}
                        >
                          <FaCheckCircle className="text-green-500 text-2xl flex-shrink-0 mt-1" aria-hidden="true" />
                        </motion.div>
